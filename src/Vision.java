...
public class Vision extends VisionModule {
  ...
  public IntegerSliderVariable maxHue = new IntegerSliderVariable("Max Hue", 93, 0, 255);
	...
	public IntegerSliderVariable minVal = new IntegerSliderVariable("Min Value", 0,  0, 83);
	//Default, Minimum, Maximum
